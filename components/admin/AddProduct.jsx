...
const AddProduct = ({ setIsProductModal }) => {
  ...
  const handleCreate = async () => {
    ...
    data.append("upload_preset", "food-web");

    try {
      const uploadRes = await axios.post(
        "https://api.cloudinary.com/v1_1/dqmitrr93/image/upload",
        data
      );
          ...
          >
            ...
            <div className="flex flex-col text-sm mt-6">
              <label className="flex gap-2 items-center">
                ...
                />
                <button
                  className="btn-primary !rounded-none !bg-violet-600
                            pointer-events-none"
                >
                  Resim Seç
                </button>
                {imageSrc && (
                  <div>
                    ...
                    <img src={imageSrc} alt="" className="w-12 h-12 rounded" />
                  </div>
                )}
              </label>
            </div>
            ...
            <div className="flex flex-col text-sm mt-4">
              <span className="font-semibold mb-[2px]">Kategori Seçin</span>
              <select
                className="border-2 p-1 text-sm px-1 outline-none"
                placeholder="Başlık ismi yazın"
            ...
            <div className="flex flex-col text-sm mt-4 w-full">
              ...
              <div className="flex gap-6 w-full md:flex-nowrap flex-wrap">
                ...
                onClick={handleExtra}>Ekle</button>
              </div>
