...
const Index = ({ food }) => {
  ...
  const handleSize = (sizeIndex) => {
    ...
    // Seçilen boyuta sarı kenarlık ekleyelim
        ...
        <div>
          ...
          {food.category === "pizza" && (
            <div className="flex items-center gap-x-20 md:justify-start justify-center">
              <div
                className={`relative w-8 h-8 cursor-pointer size-option ${
                  size === 0 ? "selected" : ""
                }`}
              ...
              <div
                className={`relative w-12 h-12 cursor-pointer size-option ${
                  size === 1 ? "selected" : ""
                }`}
              ...
              <div
                className={`relative w-16 h-16 cursor-pointer size-option ${
                  size === 2 ? "selected" : ""
                }`}
